...
// =====================================================
//  src/app/page.tsx — ホーム画面（Sprint #62 刷新版）
//
//  ⚠️ このファイルが / ルートを優先的に処理するため、
//     src/app/(dashboard)/page.tsx の内容をここに移植。
//     (dashboard)/layout.tsx を経由しないため、
//     MunicipalityProvider + Sidebar を自前でラップする。
//
//  ■ セクション構成
//    ① ヒーロー        : 価値訴求 + 選択中自治体
...
import { MunicipalityProvider, useMunicipality } from '@/contexts/MunicipalityContext';
...
// ─── メインコンテンツ（MunicipalityProvider 内部で使う）──
    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center flex-shrink-0">
          <div>
            <h2 className="text-lg font-bold text-slate-800">RunWith Platform</h2>
 ...
 * Home
 *
 * src/app/page.tsx は (dashboard)/layout.tsx を経由しないため、
 * MunicipalityProvider を自前でラップして useMunicipality() を使えるようにする。
 */
