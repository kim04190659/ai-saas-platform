...
分析結果の見方・施策案の活用・産業台帳データの更新について説明してください。回答は400字以内。`,
  ...
  '/kirishima': {
    ...
    description: '霧島市専用のRunWithダッシュボードへようこそ。KPI・市民満足度・職員WellBeingをまとめて確認できます。',
    systemPrompt: `あなたはRunWith Platform（霧島市専用）の操作サポートAIです。
現在のページは「霧島市 RunWithトップページ」です。左メニューの各機能（KPI・市民接触・職員WB・知識管理）へのナビゲーションページです。
各機能の概要・使い方・始め方を中心に案内してください。回答は400字以内。`,
    suggestions: ['KPIダッシュボードの使い方は？', '市民接触データはどこで見る？', '職員WBを入力するには？', 'PDCAの進め方を教えて'],
  },
  '/kirishima/kpi': {
      ...
      <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            {/* ■ 名称統一：全ページ「RunWithアシスタント」 */}
            <h2 className="font-semibold text-sm text-gray-800">RunWithアシスタント</h2>
          </div>
